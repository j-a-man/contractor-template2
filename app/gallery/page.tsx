        ...
        <>
            ...
            <div className="pt-32 pb-24 px-6 md:px-12 bg-[#f5f5f5] min-h-screen text-[#0f0f0f]">
                <div className="max-w-screen-2xl mx-auto">
                    <div className="border-b border-neutral-300 pb-12 mb-16">
                        ...
                        <p className="text-neutral-600 max-w-2xl text-lg font-light">
                    ...
                    <div className="columns-1 md:columns-2 lg:columns-3 gap-6 space-y-6">
                        {images.map((src, i) => (
                            <div key={i} className="break-inside-avoid relative group overflow-hidden rounded-sm shadow-sm">
                                <img src={src} className="w-full h-auto object-cover transition-all duration-700 group-hover:scale-105" alt="Gallery Item" />
                                ...
                                <div className="absolute bottom-4 left-4 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                                    <span className="text-white text-xs tracking-widest uppercase drop-shadow-md">Project 0{i + 1}</span>
                                </div>
                            </div>
                        ))}
                    </div>
